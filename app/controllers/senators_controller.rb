class SenatorsController < ApplicationController
  ...
  def index
    ...
    @senadores.each do |senador|
        ...
        novo = Senator.new(:CodigoParlamentar => senador.IdentificacaoParlamentar.CodigoParlamentar,
  ...
  private
    ...
    def senator_params
      params.require(:senator).permit(:CodigoParlamentar, :Nome, :UrlFoto, :UrlPagina, :Email, :SiglaPartido, :UF)
    end
end
